...
#	var i_right_eye_rotation: Vector3 = interpolation_data.interpolate(interpolation_data.InterpolationDataType.RIGHT_EYE_ROTATION, interpolation_rate)
	...
	assert_true(i_translation == input_target_translation * interpolation_rate * interpolation_data.base_interpolation_rate)
	assert_true(i_rotation == input_target_rotation * interpolation_rate * interpolation_data.base_interpolation_rate)
